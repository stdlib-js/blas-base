...
```javascript
import { ccopy, cscal, cswap, dasum, daxpy, dcabs1, dcopy, ddot, diagonalTypes, dnrm2, drotg, dscal, dsdot, dswap, gasum, gaxpy, gcopy, gdot, gnrm2, gscal, gswap, idamax, isamax, layouts, matrixTriangles, operationSides, sasum, saxpy, scabs1, scopy, sdot, sdsdot, snrm2, srotg, sscal, sswap, transposeOperations, zcopy, zswap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base@esm/index.mjs';
```
